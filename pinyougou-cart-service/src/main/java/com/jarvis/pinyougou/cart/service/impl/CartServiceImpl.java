package com.jarvis.pinyougou.cart.service.impl;
...
/**
 * @Description:
 * @CreateDate: 2019/8/11 21:39
 * @UpdateUser: jarvis
 * @UpdateDate: 2019/8/11 21:39
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
...
public class CartServiceImpl implements CartService {
    ...
    public List<Cart> addGoodsToCartList(List<Cart> cartList, Long itemId, Integer num) {
        ...
        System.out.println("============"+itemMapper.selectByPrimaryKey(itemId).getTitle());
        ...
        if(cart==null){
            ...
            if(orderItem==null){
                ...
                //如果移除后，cart的明细数量为0 ，则将cart移除
                if(cart.getOrderItemList().size()==0){

                    cartList.remove(cart);
                }
                for(Cart show:cartList){
                    System.out.println(show.getSellerName());
                }
            }
